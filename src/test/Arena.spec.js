...
describe('Arena::Class', () => {
  describe('initialiseRobots::Method', () => {
    it('should create the correct number of robot objects', () => {
      const instructions = ['1 2 N', 'LMLMLMLMM', '3 3 E', 'MMRMMRMRRM', '4 4 S', 'MMRMMRMRRM'];
      const arena = new Arena(10, 10, instructions);
      arena.initialiseRobots(instructions);
      expect(arena.robots.length).to.be.equal(3);
    });
    it('should initialise robots with the correct bounds', () => {
      const instructions = ['1 2 N', 'LMLMLMLMM', '3 3 E', 'MMRMMRMRRM'];
      const arena = new Arena(5, 5, instructions);
      arena.initialiseRobots(instructions);
